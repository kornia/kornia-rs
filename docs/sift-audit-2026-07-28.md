...
| B3/D7 per-layer counts | CONFIRMED all claims; per-layer starts must reach the host anyway (kp_in slice offset is a host arg, plan.rs:423) — the widened readback supplies exactly that. |
