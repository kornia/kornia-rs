...
pub use sift::{
    ...
    gaussian_kernel_f32, gaussian_ksize, gradients, l2_sq, l2_sq_scalar, magnitude,
    sift_detect_and_compute, sift_detect_with, sift_exp, sift_match_descriptors,
    sift_match_descriptors_scalar, FirstOctave, OrientedKeypoint, RawKeypoint, SiftConfig,
