...
fn main() {
    let cases: Vec<(&str, Vec<u8>, usize, usize, usize)> = vec![
        ...
        (
            "2 disjoint squares same row",
            fill(20, 8, &[(2, 2, 6, 6), (2, 12, 6, 16)]),
            20,
            8,
            2,
        ),
        (
            "2 disjoint squares stacked",
            fill(20, 16, &[(2, 2, 6, 6), (10, 2, 14, 6)]),
            20,
            16,
            2,
        ),
        (
            "3 in a row",
            fill(30, 8, &[(2, 2, 6, 6), (2, 12, 6, 16), (2, 22, 6, 26)]),
            30,
            8,
            3,
        ),
        ...
        (
            "U-shape (horseshoe)",
            fill(10, 10, &[(1, 1, 8, 3), (1, 7, 8, 9), (6, 1, 8, 9)]),
            10,
            10,
            1,
        ),
        (
            "checker 4x4",
            (0..16).map(|i| ((i / 4 + i % 4) & 1) as u8).collect(),
            4,
            4,
            1,
        ),
