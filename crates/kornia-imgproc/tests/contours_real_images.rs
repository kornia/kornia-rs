...
fn pic1_external_matches_cv2() {
    let Some(img) = load_binary("pic1.png") else {
        return;
    };
...
fn pic2_external_matches_cv2() {
    let Some(img) = load_binary("pic2.png") else {
        return;
    };
...
fn pic3_external_matches_cv2() {
    let Some(img) = load_binary("pic3.png") else {
        return;
    };
...
fn pic4_external_matches_cv2() {
    let Some(img) = load_binary("pic4.png") else {
        return;
    };
