...
TEST_CASE("ImageU8C3 basic interface", "[image][u8c3]") {
    // Create a test image (100x80, filled with value 42)
    kornia::ImageU8C3 image(create_test_image_u8c3(100, 80, 42));
...
TEST_CASE("ImageU8C1 basic interface", "[image][u8c1]") {
    // Create a test grayscale image (50x60, filled with value 128)
    kornia::ImageU8C1 image(create_test_image_u8c1(50, 60, 128));
...
TEST_CASE("Image move semantics", "[image][move]") {
    kornia::ImageU8C3 image1(create_test_image_u8c3(100, 80, 42));
    ...
    SECTION("Move assignment") {
        kornia::ImageU8C3 image2(create_test_image_u8c3(50, 50, 0));
