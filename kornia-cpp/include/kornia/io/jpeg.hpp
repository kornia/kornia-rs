...
inline ImageU8C3 read_image_jpeg_rgb8(const std::string& file_path) {
    return ImageU8C3(::read_image_jpeg_rgb8(file_path)); // Call FFI function from global namespace
}
...
inline ImageU8C1 read_image_jpeg_mono8(const std::string& file_path) {
    return ImageU8C1(::read_image_jpeg_mono8(file_path)); // Call FFI function from global namespace
}
