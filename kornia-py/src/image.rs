...
impl PyImageApi {
    ...
    fn numpy_view_of(slf: Bound<'_, Self>) -> PyResult<Py<PyAny>> {
        ...
        // For non-numpy borrowed backings, fall through to build a real numpy view
        // over the backing pointer (with the Image as base, keeping the source alive).
        ...
        // Owned or buffer-backed borrow: build a view (Image as base).
        let dtype = me.dtype;
