...
def rgb_from_gray(img: Image) -> Image: ...
def bgr_from_rgb(img: Image) -> Image: ...
def rgba_from_rgb(img: Image) -> Image: ...
def rgb_from_rgba(img: Image) -> Image: ...
def rgb_from_bgra(img: Image) -> Image: ...
def ycbcr_from_rgb(img: Image) -> Image: ...
def rgb_from_ycbcr(img: Image) -> Image: ...
def hsv_from_rgb(img: Image) -> Image: ...
def rgb_from_hsv(img: Image) -> Image: ...
def lab_from_rgb(img: Image) -> Image: ...
def rgb_from_lab(img: Image) -> Image: ...
def sepia_from_rgb(img: Image) -> Image: ...
def apply_colormap(img: Image, colormap: str) -> Image: ...
def rgb_from_bayer(img: Image, pattern: str) -> Image: ...
